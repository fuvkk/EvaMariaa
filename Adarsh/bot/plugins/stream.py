...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_link = f"dotexhub-7psn.onrender.com/watch/{str(log_msg.id)}/?hash={get_hash(log_msg)}"
        online_link = f"dotexhub-7psn.onrender.com/{str(log_msg.id)}/?hash={get_hash(log_msg)}"
