...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_link = f"https://invizher.eu.org/watch/{str(log_msg.id)}/?hash={get_hash(log_msg)}"
        online_link = f"https://invizher.eu.org/{str(log_msg.id)}/?hash={get_hash(log_msg)}"
